  ...
  return (
    <div style={{ background: C.bg, color: C.text, minHeight: "100vh", fontFamily: "'Manrope',sans-serif", fontSize: 15 }}>
      <div style={{ maxWidth: 760, margin: "0 auto", padding: "64px 24px 96px" }}>
        ...
        <div style={{ fontFamily: "'Space Mono',monospace", fontSize: 11.5, letterSpacing: 1, color: C.dim, marginBottom: 28 }}>Last updated: 29 July 2026</div>
        ...
        <P>MIREC is an early-stage project operated by <strong style={{ color: C.head }}>Ali Musabeyoğlu</strong>, based in Istanbul, Türkiye. In this policy, &quot;we&quot;, &quot;us&quot;, and &quot;MIREC&quot; refer to that operator, who is the data controller for the personal data described below.</P>
        ...
        <P>With your consent, we also use the <strong style={{ color: C.head }}>Meta Pixel</strong> (Meta Platforms) to measure the effectiveness of our advertising — for example, whether an ad brought you here and whether you joined the waitlist. The pixel is <strong style={{ color: C.head }}>off by default</strong> and loads only after you click &quot;Accept&quot; in the cookie banner. Declining does not affect your ability to use the site, and you can change your mind at any time via the &quot;Cookie preferences&quot; link in the site footer, which reopens the banner. Data collected by the pixel is processed by Meta as described in Meta&apos;s own privacy policy.</P>
